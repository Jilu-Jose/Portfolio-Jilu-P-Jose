...
const certs = [
    { title: 'Introduction to Machine Learning', provider: 'NPTEL', image: '/images/Introduction_to_machine_learning_Certificate.png', date: 'Nov 22, 2025', credentialId: 'NPTEL-ML', certificateLink: 'https://drive.google.com/file/d/1_s4CuB7keaVQnzP6reUfhM-EDy7D7bq-/view' },
    { title: 'Cloud Computing (Rank Top 2%)', provider: 'NPTEL', image: '/images/Cloud_Computing_NPTEL_Certificate.png', date: 'Nov 18, 2025', credentialId: 'NPTEL-CC', certificateLink: 'https://drive.google.com/file/d/1rVmP0NiXoyIHMENeQuKyLgOlOjviN1HH/view' },
    { title: 'Oracle Database @AWS Architect (Professional)', provider: 'Oracle Cloud Infrastructure', image: '/images/Oracle_AWS_Database_Certificate.png', date: 'Oct 31, 2025', credentialId: 'ORA-AWS-PRO', certificateLink: 'https://drive.google.com/file/d/1pIjEbkmJMWkujEdZckSaeSngudD-g_Tx/view' },
    { title: 'Oracle 2025 DevOps (Professional)', provider: 'Oracle Cloud Infrastructure', image: '/images/Oracle_DevOps_Certificate.png', date: 'Oct 28, 2025', credentialId: 'ORA-DEVOPS-PRO', certificateLink: 'https://drive.google.com/file/d/1XOfs_udTXmeegYAROjIVRa1QzrvAXgw-/view' },
