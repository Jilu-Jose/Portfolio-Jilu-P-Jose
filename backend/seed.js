...
const projects = [
    {
        ...
        liveLink: 'https://n-o-v-a-system.onrender.com/'
    },
    {
        title: 'S.E.N.T.R.A',
...
const models = [
    {
        name: 'alpha-pulse-v6.4.10',
        description: 'Predict stock prices using LSTM (Long Short Term Memory) based model.',
        accuracy: '92.47%',
        size: '120MB',
        link: 'https://github.com/username/house-price-regression'
    },
    {
        name: 'gahon-mk3-v3.1.4',
        description: 'Classification of Gamma and Hadron Events from Cherenkov Telescope',
        accuracy: '88.67%',
        size: '98MB',
        link: 'https://github.com/username/resnet-image-classifier'
    },
    {
        name: 'rhizoid-mk2-v2.6.10',
        description: 'Predicts Agriculture yield based on agro-environmental data.',
        accuracy: '97.40%',
        size: '126MB',
        link: 'https://github.com/username/credit-default-classifier'
    },
    {
        name: 'florasen-mk2-v5.6.11',
        description: 'Predicts Agriculture yield based on agro-environmental data.',
        accuracy: '98.60%',
        size: '120MB',
        link: 'https://github.com/username/credit-default-classifier'
...
const seedDB = async () => {
    try {
        ...
        await ModelAPI.insertMany(models);
